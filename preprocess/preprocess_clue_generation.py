...
def parse_word_list(text, list_name):
    """Parse black, tan, or targets list from text."""
...
# Load the raw data
df = pd.read_csv('data/raw/clue_generation.csv')
...
for idx, row in df.iterrows():
    ...
    targets = parse_word_list(all_text, 'targets')
...
# Save to CSV
preprocessed_df.to_csv('data/preprocessed/clue_generation.csv', index=False)
